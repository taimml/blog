        ...
        <main className="flex min-h-screen bg-white ">
            <div className="hidden lg:block w-64 bg-black text-white p-6 border-r">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Link href="/admin/comments" className="p-3">Комментарии</Link>
                    <Link href="/admin/feedback" className="p-3">Формы</Link>
                    <Link href="/admin/posts" className="p-3">Посты</Link>
                </div>
                <div className="mt-8">
